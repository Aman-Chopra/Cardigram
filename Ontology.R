...
#Note : As there were only 3 missing values in the Entire Dataset (specifically in FI attribute) , only a mean was used for the missing values.
...
nn_2 <- neuralnet(f_2 , data = nn_train_2 , hidden = c(5.3) , linear.output = T)
plot(nn_2)
print("Making Predictions on Test Dataset")
...
nn_3 <- neuralnet(f_3 , data = nn_train_3 , hidden = c(5.3) , linear.output = T)
plot(nn_3)
print("Making Predictions on Test Dataset")
...
nn_4 <- neuralnet(f_4 , data = nn_train_4 , hidden = c(5.3) , linear.output = T)
plot(nn_4)
print("Making Predictions on Test Dataset")
...
nn_entire <- neuralnet(f_entire , data = nn_train_entire , hidden = c(5.3) , linear.output = T)
plot(nn_entire)
print("Making Predictions on Test Dataset")
